...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
	switch (keycode) {
      ...
      return false;
		case M_BLRT: //borderlands run forward
			if (record->event.pressed) {
        register_code(KC_D);
        send_string(SS_TAP(X_P5));
       } else {
      ...
      return false;
		case M_BLLF: //borderlands run forward
			if (record->event.pressed) {
        register_code(KC_A);
        send_string(SS_TAP(X_P5));
       } else {
...
*/
	[_GAME_FUNCTION] = LAYOUT(
     KC_DEL,KC_F1,KC_7,KC_8,KC_9,KC_F4,  _______,_______,_______,_______,_______,M_BLNDS,
    ...
    _______,_______,_______,M_BLRUN,_______,_______,_______,_______,_______,_______,TG(_BLNDS),_______,
		_______,_______,M_BLLF,_______,M_BLRT,_______,_______,_______,_______,_______,_______,_______,
